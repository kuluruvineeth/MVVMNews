...
import com.kuluruvineeth.mvvmnews.NewsApplication
...
class NewsViewModel(
    ...
    private fun hasInternetConnection():Boolean{
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            val activeNewtwork = connectivityManager.activeNetwork ?: return false
            val capabilities = connectivityManager.getNetworkCapabilities(activeNewtwork) ?: return false
            return when{
